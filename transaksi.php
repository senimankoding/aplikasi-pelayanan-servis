		...
		<div class="row-fluid sortable">		
				<div class="box span6">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Penerimaan Barang</h2>
						<div class="box-icon">
			...
			<div class="box-content">
			  	<form class="form-horizontal" action="aksi/proses.php?kirim" method="post">
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="nmbarang" placeholder="Enter Nama Barang" required>
					    </div>
					  </div><br>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="nmpemilik" placeholder="Enter Nama Pemilik" required>
					    </div>
					  </div><br>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="tlpn" placeholder="Enter No.Tlpn" required>
					    </div>
					  </div><br>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="kerusakan" placeholder="Enter Kerusakan" required>
					    </div>
					  </div><br>
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="kelengkapan" placeholder="Enter Kelengkapan" required>
					    </div>
					  </div><br>
					  ...
					  <!-- <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="date" class="form-control" name="tglditerima" value="mm/dd/yyyy" required><span style="color:#0573fb;">bln/tgl/thn</span>
					    </div>
					  </div><br> -->
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="penerimabarang" placeholder="Enter Penerima Barang" required>
					    </div>
					  </div><br>
					 ...
					 <div class="form-group">
						...
						<div class="col-sm-6">
							<input type="submit" name="kirim2" class="btn btn-sm btn-info" value="tambah">
