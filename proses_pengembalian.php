		...
		<div class="row-fluid sortable">		
				<div class="box span6">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>Penyerahan Barang</h2>
						<div class="box-icon">
			  	...
			  	<form class="form-horizontal" action="aksi/proses.php?kirim" method="post">
					  ...
					  <div class="form-group">
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="teknisi" value="<?php echo $row ['9']; ?>" required readonly>
					    </div>
					  </div><br>
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="kondisibrg" value="<?php echo $row ['10']; ?>" required readonly>
					    </div>
					  </div><br>
					 ...
					 <!--   <div class="form-group">
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="penyerahanbarang" value="<?php echo $row ['12']; ?>" required>
					    </div>
					  </div><br>
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-10"> 
					      <input type="text" class="form-control" name="biaya" value="<?php echo $row ['13']; ?>" required readonly>
					    </div>
					  </div><br>
					 ...
					 <div class="form-group">
						...
						<div class="col-sm-6">
							<input type="submit" name="update2" class="btn btn-sm btn-info" value="tambah">
